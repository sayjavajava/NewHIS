...
//    }
//
//    public static List<ICDCodeWrappe> buildICDCodesWrapper(List<ICDCode> iCDs) {
//        List<ICDCodeWrapper> wrapperList = new ArrayList<>();
//        for (ICDCode icd : iCDs) {
//            ICDCodeWrapper wrapper = new ICDCodeWrapper(icd);
//            wrapperList.add(wrapper);
...
//        dbTax.setFromDate(DateTimeUtil.getMillisFromStringDate(requestTax.getFromDate(), HISConstants.DATE_FORMATE_THREE));
//        dbTax.setToDate(DateTimeUtil.getMillisFromStringDate(requestTax.getToDate(), HISConstants.DATE_FORMATE_THREE));
//    }
//
