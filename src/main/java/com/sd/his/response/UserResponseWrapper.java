...
public class UserResponseWrapper {
    ...
    List<ClinicalDepartment> clinicalDepartment;
   ...
   public UserResponseWrapper(){}
    ...
    public List<ClinicalDepartment> getClinicalDepartment() {
        return clinicalDepartment;
    }

    public void setClinicalDepartment(List<ClinicalDepartment> clinicalDepartment) {
