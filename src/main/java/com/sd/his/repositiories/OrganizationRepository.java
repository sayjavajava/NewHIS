...
@Query("SELECT new com.sd.his.response.OrganizationResponseWrapper(o.id,o.userName,o.companyName,o.cellPhone,o.aptSerialStart,o.website,ou.email) FROM Organization o INNER JOIN o.user ou where o.active =TRUE AND o.deleted =FALSE ")
