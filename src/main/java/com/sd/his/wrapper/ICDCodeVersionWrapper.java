...
public class ICDCodeVersionWrapper {
    ...
    public ICDCodeVersionWrapper(ICDCodeVersion codeVersion, ICDCode code, ICDVersion version) {
        this.id = codeVersion.getId();
        this.description = codeVersion.getDescription();
        this.icdCode = new ICDCodeWrapper(code);
        this.icdVersion = new ICDVersionWrapper(version);
    }
