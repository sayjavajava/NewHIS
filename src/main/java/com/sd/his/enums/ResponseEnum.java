...
public enum ResponseEnum {
    ...
    ALLERGY_SAVE_ERROR("ALLERGY_ERR_18"),
    ALLERGY_PAGINATED_SUCCESS("ALLERGY_SUC_18"),
    ALLERGY_PAGINATED_ERROR("ALLERGY_ERR_19"),
    ALLERGY_UPDATE_SUCCESS("ALLERGY_SUC_20"),
    ALLERGY_UPDATE_ERROR("ALLERGY_ERR_21"),
    ALLERGY_UPDATE_ALREADY_DEL("ALLERGY_SUC_26"),
    ALLERGY_DELETE_SUCCESS("ALLERGY_SUC_22"),
    ALLERGY_DELETE_ERROR("ALLERGY_ERR_23"),
    ALLERGY_GET_SUCCESS("ALLERGY_SUC_24"),
    ALLERGY_GET_ERROR("ALLERGY_ERR_25"),
